...
SceneMgr::SceneMgr()
{
	...
	m_texCharacter = m_Renderer->CreatePngTexture("./resourse/에펠탑.png");
	m_texCharacter2 = m_Renderer->CreatePngTexture("./resourse/활짝.png");
	m_texBackGround = m_Renderer->CreatePngTexture("./resourse/배경.png");
